    ...
    <Dialog>
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto p-8">
        <DialogHeader className="space-y-4">
          <DialogTitle className="text-3xl font-bold text-primary">Join Our Volunteer Team</DialogTitle>
          <DialogDescription className="text-lg leading-relaxed">
            Thank you for your interest in volunteering with ADOWO. Please fill out this application form to get
            started.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-8 mt-8">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-xl text-primary">Volunteer Preferences</CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-2">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-xl text-primary">Skills and Experience</CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                <Label htmlFor="motivation">Why do you want to volunteer with ADOWO? *</Label>
                <Textarea
                  id="motivation"
        ...
        <div className="mt-6 text-center p-4 bg-muted/50 rounded-lg border">
          <p className="text-sm text-muted-foreground">
            After submitting your application, our team will review it and contact you within 5-7 business days. For
            questions, contact us at <strong className="text-primary">volunteers@adowo.org</strong>
          </p>
        </div>
      </DialogContent>
    </Dialog>
